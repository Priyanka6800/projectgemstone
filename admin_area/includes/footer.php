	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:08022108778">080-22102778</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:gemstonegallery@yourwebsite.com" class="email__addr">gemstonegallery@website.com</a>
				</div>
			</div>
